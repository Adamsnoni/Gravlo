...
export default function UnitCard({ unit, fmtRent, onVacate, onEdit, onDelete, propertyId, propertyName, currencySymbol = '₦' }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2 pt-2">
                {isOccupied ? (
                    <button onClick={() => onVacate(unit)} className="flex-1 btn-secondary py-3 text-[10px] font-black uppercase text-[#e74c3c] border-transparent hover:bg-red-50 hover:border-[#fee2e2] transition-all">
                        <UserMinus size={14} strokeWidth={3} /> Vacate Unit
                    </button>
                ) : (
